...
if __name__ == '__main__':
	...
	# print("0x{0}".format(hash1))
	# print("{0}\t0x{1}".format(s, hash1))
	#
	# s = '看看哪些东西google最看重！标点！'
	# hash2 = simhash(s.split())
	# print("{0}\t[simhash = 0x{1}]".format(s, hash2))
	#
	# print('{0}% percent similarity on hash'.format(100*(hash1.similarity(hash2))))
	...
	for file in feature_file:
		...
		with open(file+"_fingerprint", 'w') as outs:
